...
from ProfileApp.serializers import ProfileSerializers, AboutSerializers, SkillSerializer

from UserApp.models import User,UserFollowing
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'username', 'email', 'password', 'date_joined', 'following',
                  'followers', 'posts', 'user_profile', 'user_about',
                  'user_skills','activities']
